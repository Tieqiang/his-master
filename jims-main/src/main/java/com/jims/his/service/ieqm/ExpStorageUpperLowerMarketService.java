...
public class ExpStorageUpperLowerMarketService {
    ...
    public List<ExpStorageProfileVo> listExpMenuSearch(@QueryParam("storageCode") String storageCode,@QueryParam("startTime") Date startTime,@QueryParam("stopTime") Date stopTime,@QueryParam("hospitalId") String hospitalId){
