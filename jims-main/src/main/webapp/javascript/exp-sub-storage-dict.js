$(function () {
    ...
    $("#dg").datagrid({
        ...
        columns: [[{
            ...
            width: "10%",
            editor:{type:'validatebox',options:{required:true,validType:'length[0,6]',missingMessage:'请输入6字符以内的入库单前缀',invalidMessage:'输入值不在范围'}}
        }, {
            title: '当前入库号',
            field: 'importNoAva',
            width: "7%",
            editor:{type:'numberbox',options:{required:true,validType:'length[0,4]',missingMessage:'请输入0-9999的数字',invalidMessage:'输入值不在范围'}}
        }, {
            title: '出库单号前缀',
            field: 'exportNoPrefix',
            width: "10%",
            editor:{type:'validatebox',options:{required:true,validType:'length[0,6]',missingMessage:'请输入6字符以内的出库单号前缀',invalidMessage:'输入值不在范围'}}
        }, {
            title: '当前出库号',
            field: 'exportNoAva',
            width: "7%",
